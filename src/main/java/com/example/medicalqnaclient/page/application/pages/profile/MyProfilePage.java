package com.example.medicalqnaclient.page.application.pages.profile;

import com.example.medicalqnaclient.page.application.pages.ApplicationPage;
import com.example.medicalqnaclient.page.application.pages.profile.basic.MyProfileStrategy;
