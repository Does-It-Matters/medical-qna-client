package com.example.medicalqnaclient.page.pages.sign.up.doctor.basic;
...
public class DoctorSignUpController extends ViewController {
    ...
    @Autowired
    public DoctorSignUpController(QnAPublisher publisher, ReadWriteUserMediator mediator) {
