package com.example.medicalqnaclient.server.application.tasks.signup.doctor;

import com.example.medicalqnaclient.server.application.tasks.signup.common.SignUpResponse;
import com.example.medicalqnaclient.server.utils.network.Response;
import com.example.medicalqnaclient.server.utils.network.Post;
import com.example.medicalqnaclient.server.utils.format.JsonFormatter;
