package com.example.medicalqnaclient.domain.application.page.pages.home.log.out;
...
public class QuestionsLoggedOutUsersController extends ApplicationController {
    ...
    @Autowired
    public QuestionsLoggedOutUsersController(ApplicationPublisher publisher, ReadWriteUserMediator mediator) {
